...
/*   Updated: 2022/02/21 13:40:58 by tmartial         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	forward(t_data *data, int press);
void	back(t_data *data, int press);
void	left(t_data *data, int press);
void	right(t_data *data, int press);
